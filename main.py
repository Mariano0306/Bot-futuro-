...
import ta
import pandas as pd
from flask import Flask  # 👈 Agregamos Flask

# 🚨 Para simular un servicio web y que Render no falle
app = Flask(__name__)
@app.route('/')
def home():
...
# 👇 Loop principal ahora se ejecuta aparte
def start_bot():
...
# 🔁 Arranca el bot en un hilo aparte
import threading
threading.Thread(target=start_bot).start()

# ✅ Lanza Flask para Render
